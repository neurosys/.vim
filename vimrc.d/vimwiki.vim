...
let g:vimwiki_list = [{'path': '~/.vimwiki/keysight', 'syntax': 'markdown', 'ext': 'md'},
            \ {'path': '~/.vimwiki/thermo', 'syntax': 'markdown', 'ext': 'md'},
            \ {'path': '~/.vimwiki/honda', 'syntax': 'markdown', 'ext': 'md'},
            ...
            \ {'path': '~/.vimwiki/rinf', 'syntax': 'markdown', 'ext': 'md'}]
